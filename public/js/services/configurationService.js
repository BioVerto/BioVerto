angular.module("MyApp")
    .service('configurationService', function() {
        ...
        var forceLayoutControlsObj = [
            ...
            {controltype: "select",      datatype: "character",default: "None",   tab: "Node", label: "Node Label",      func: "nodeLabelAccessor",ignore:false},
            {controltype: "select",      datatype: "number",   default:"None" ,   tab: "Node", label: "Node Size",       func: "nodeSizeAccessor", ignore:false},
	    ...
	    {controltype: "select",      datatype: "number",   default:"None" ,   tab: "Node", label: "Color Attribute",func: "nodeColorAccessor", ignore:false},
            ...
            {controltype: "select",      datatype: "number",   default:"None" ,   tab: "Edge", label: "Edge Size",       func: "edgeWidthAccessor", ignore:false},
            ...
            {controltype: "select",      datatype: "character",default:"None" ,      tab: "Edge", label: "Edge Label ",      func: "edgeLabelAccessor", ignore:true},
        ...
        var chordLayoutControlsObj = [
            {controltype: "select",      datatype: "number",     tab: "Node", label: "Chord Attribute",      func: "nodeAccessor", ignore:false},
